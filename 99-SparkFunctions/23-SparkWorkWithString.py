...
from pyspark.sql.functions import col, initcap, lower, upper, trim, split, length, substring, concat, instr, lit

# Création d'une session Spark
spark = SparkSession.builder.appName("23-SparkWorkWithString.py").getOrCreate()
