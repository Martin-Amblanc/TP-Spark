#*************************************
#*** 22-SparkWorkingWithNumbers.py ***
#*************************************
from pyspark.sql import SparkSession
from pyspark.sql.functions import col, round, sum, when

# Création d'un DataFrame de test
spark = SparkSession.builder.appName("22-SparkWorkingWithNumbers.py").getOrCreate()
...
# Création d'un DataFrame de test
spark = SparkSession.builder.appName("22-SparkWorkingWithNumbersComplex.py").getOrCreate()
df = spark.createDataFrame([(10, 2), (20, 5), (15, 3)], ["quantite", "prix_unitaire"])

# Opérations de base et agrégation
fabricatedQuantity = col("quantite") * col("prix_unitaire")
df_calculs = df.select(expr("CustomerId"), fabricatedQuantity.alias("prix_total_ht")).show()
...
# la méthode describe prend en compte les colonnes numériques et calcule le nombre, la moyenne, l'écart type, le minimum et le maximum.
total_ht.describe().show()
